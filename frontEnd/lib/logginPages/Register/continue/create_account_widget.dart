                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0, 12, 0, 24),
                                child: Text(
                                  'Please fill out all of the fields below to create your account.',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.firstPasswordTextController.text ==
                                      ...
                                      : false) {
                                        try {
                                          bool success = await createAccount(_model.userEmailTextController.text, _model.userNameTextController.text, _model.firstPasswordTextController.text);
                                          if (success) {
                                            context.go('/login');
                                          }
                                        } catch (e) {
